...
const AllowBareDDL: $AllowBareDDL = $.makeType<$AllowBareDDL>(_.spec, "0bc08118-27fb-11ee-88b3-f52d88c27610", _.syntax.literal);
...
const ConnectionTransport: $ConnectionTransport = $.makeType<$ConnectionTransport>(_.spec, "0bc0d03c-27fb-11ee-be6c-4d2afd28eabb", _.syntax.literal);
...
const $ConfigObject = $.makeType<$ConfigObject>(_.spec, "0bc11ee8-27fb-11ee-9721-c56a59003d24", _.syntax.literal);
...
const $AbstractConfig = $.makeType<$AbstractConfig>(_.spec, "0bdf305e-27fb-11ee-a0b5-5999ba846422", _.syntax.literal);
...
const $Auth = $.makeType<$Auth>(_.spec, "0bd63bca-27fb-11ee-83f3-79362cbe37f3", _.syntax.literal);
...
const $AuthMethod = $.makeType<$AuthMethod>(_.spec, "0bc4e514-27fb-11ee-952e-fdb539c4d142", _.syntax.literal);
...
const $Config = $.makeType<$Config>(_.spec, "0bfb708e-27fb-11ee-9ca1-69cc0da90e67", _.syntax.literal);
...
const $DatabaseConfig = $.makeType<$DatabaseConfig>(_.spec, "0c2b14f6-27fb-11ee-8f31-af38b5b882f7", _.syntax.literal);
...
const $InstanceConfig = $.makeType<$InstanceConfig>(_.spec, "0c133c6e-27fb-11ee-bbaf-cf0c0bd52080", _.syntax.literal);
...
const $JWT = $.makeType<$JWT>(_.spec, "0bd187e2-27fb-11ee-8cae-5377ddaf835a", _.syntax.literal);
...
const $SCRAM = $.makeType<$SCRAM>(_.spec, "0bccfbc8-27fb-11ee-94bf-c9c1ed9f7d20", _.syntax.literal);
...
const $Trust = $.makeType<$Trust>(_.spec, "0bc8e60a-27fb-11ee-b2f2-63000ef2a57e", _.syntax.literal);
...
function get_config_json(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('cfg::get_config_json', args, _.spec, [
    {args: [], namedArgs: {"sources": {typeId: "06d79d80-27fb-11ee-8907-532ef9a47a2d", optional: true, setoftype: false, variadic: false}, "max_source": {typeId: "00000000-0000-0000-0000-000000000101", optional: true, setoftype: false, variadic: false}}, returnTypeId: "00000000-0000-0000-0000-00000000010f"},
  ]);
