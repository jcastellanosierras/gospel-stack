...
import type * as $ from "./reflection.ts";
import * as literal from "./literal.ts";
import type * as _std from "./modules/std.ts";
import type * as _sys from "./modules/sys.ts";
import type * as _schema from "./modules/schema.ts";
import type * as _default from "./modules/default.ts";
import type * as _api_usage from "./modules/client/api_usage.ts";
import type * as _cfg from "./modules/cfg.ts";
import type * as _cal from "./modules/cal.ts";
import type * as _inventory from "./modules/b2c/inventory.ts";
import type * as _product from "./modules/api/product.ts";
import type * as _account from "./modules/api/account.ts";
export type scalarAssignableBy<T extends $.ScalarType> =
  ...
  T extends _default.$VerificationType ? _default.$VerificationType : 
  T extends _default.$UserPermissons ? _default.$UserPermissons : 
  T extends _default.$ProductState ? _default.$ProductState : 
  T extends _default.$BrandState ? _default.$BrandState : 
  T extends _default.$AvailableRole ? _default.$AvailableRole : 
  T extends _api_usage.$RequestType ? _api_usage.$RequestType : 
  ...
  T extends _inventory.$ProductState ? _inventory.$ProductState : 
  T extends _product.$ProductState ? _product.$ProductState : 
  T extends _product.$BrandState ? _product.$BrandState : 
  T extends _account.$VerificationType ? _account.$VerificationType : 
  T extends _account.$UserPermissons ? _account.$UserPermissons : 
  T extends _account.$AvailableRole ? _account.$AvailableRole : 
  T extends _account.$ApiPermissons ? _account.$ApiPermissons : 
  never
...
type getSharedParentScalar<A, B> =
  ...
  A extends _schema.$AccessKind ?
    ...
    never
  :
  A extends _default.$VerificationType ?
    B extends _default.$VerificationType ?
    B
    :
    never
  :
  A extends _default.$UserPermissons ?
    B extends _default.$UserPermissons ?
    B
    :
    never
  :
  A extends _default.$ProductState ?
    B extends _default.$ProductState ?
    B
    :
    never
  :
  A extends _default.$BrandState ?
    B extends _default.$BrandState ?
    B
    :
    never
  :
  A extends _default.$AvailableRole ?
    B extends _default.$AvailableRole ?
    B
    :
    never
  :
  A extends _api_usage.$RequestType ?
    B extends _api_usage.$RequestType ?
    B
    :
    never
  :
  ...
  A extends _cal.$date_duration ?
    ...
    never
  :
  A extends _inventory.$ProductState ?
    B extends _inventory.$ProductState ?
    B
    :
    never
  :
  A extends _product.$ProductState ?
    B extends _product.$ProductState ?
    B
    :
    never
  :
  A extends _product.$BrandState ?
    B extends _product.$BrandState ?
    B
    :
    never
  :
  A extends _account.$VerificationType ?
    B extends _account.$VerificationType ?
    B
    :
    never
  :
  A extends _account.$UserPermissons ?
    B extends _account.$UserPermissons ?
    B
    :
    never
  :
  A extends _account.$AvailableRole ?
    B extends _account.$AvailableRole ?
    B
    :
    never
  :
  A extends _account.$ApiPermissons ?
    B extends _account.$ApiPermissons ?
    B
    :
    never
  :
...
function getSharedParentScalar<A extends $.ScalarType, B extends $.ScalarType>(a: A, b: B): A | B {
  ...
  if (a.__name__ === "default::VerificationType") {
    if(b.__name__ === "default::VerificationType") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::UserPermissons") {
    if(b.__name__ === "default::UserPermissons") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::ProductState") {
    if(b.__name__ === "default::ProductState") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::BrandState") {
    if(b.__name__ === "default::BrandState") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::AvailableRole") {
    if(b.__name__ === "default::AvailableRole") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "client::api_usage::RequestType") {
    if(b.__name__ === "client::api_usage::RequestType") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  ...
  if (a.__name__ === "b2c::inventory::ProductState") {
    if(b.__name__ === "b2c::inventory::ProductState") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "api::product::ProductState") {
    if(b.__name__ === "api::product::ProductState") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "api::product::BrandState") {
    if(b.__name__ === "api::product::BrandState") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "api::account::VerificationType") {
    if(b.__name__ === "api::account::VerificationType") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "api::account::UserPermissons") {
    if(b.__name__ === "api::account::UserPermissons") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "api::account::AvailableRole") {
    if(b.__name__ === "api::account::AvailableRole") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "api::account::ApiPermissons") {
    if(b.__name__ === "api::account::ApiPermissons") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
